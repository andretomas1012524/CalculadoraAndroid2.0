...
public class Menuresultado5 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_menuresultado5);
        Intent intent = getIntent();

        double num1 = intent.getDoubleExtra(calculobasico4.Numerobasico1,0.00);
        double num2 = intent.getDoubleExtra(calculobasico4.Numerobasico2,0.00);
        ...
        TextView textViewres = (TextView)findViewById(R.id.textRes5);
        double res = Funcoesbasicas.DivisaoInteira();
