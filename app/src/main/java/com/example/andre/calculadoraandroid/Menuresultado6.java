...
public class Menuresultado6 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_menuresultado6);
        Intent intent = getIntent();

        double num1 = intent.getDoubleExtra(calculobasico5.Numerobasico1,0.00);
        double num2 = intent.getDoubleExtra(calculobasico5.Numerobasico2,0.00);
        ...
        TextView textViewres = (TextView)findViewById(R.id.textRes6);
        double res = Funcoesbasicas.media();
