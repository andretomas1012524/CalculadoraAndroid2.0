...
public class Menuresultado4 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_menuresultado4);
        Intent intent = getIntent();

        double num1 = intent.getDoubleExtra(calculobasico3.Numerobasico1,0.00);
        double num2 = intent.getDoubleExtra(calculobasico3.Numerobasico2,0.00);
        ...
        TextView textViewres = (TextView)findViewById(R.id.textRes4);
        double res = Funcoesbasicas.Divisao();
