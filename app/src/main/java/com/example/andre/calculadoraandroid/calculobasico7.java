...
public class calculobasico7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calculobasico7);
    }


    public void calcularbasicoraiz(View view) {
        Intent intent = new Intent(this,Menuresultado8.class);

        EditText editTextnum1 = (EditText)findViewById(R.id.nbasico12);
        EditText editTextnum2 = (EditText)findViewById(R.id.nbasico13);
