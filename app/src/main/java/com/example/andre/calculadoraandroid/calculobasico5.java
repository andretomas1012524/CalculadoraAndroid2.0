...
public class calculobasico5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calculobasico5);
    }

    public void calcularbasicomedia(View view) {
        Intent intent = new Intent(this,Menuresultado6.class);

        EditText editTextnum1 = (EditText)findViewById(R.id.nbasico8);
        EditText editTextnum2 = (EditText)findViewById(R.id.nbasico9);
