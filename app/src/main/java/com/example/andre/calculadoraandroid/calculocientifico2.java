...
public class calculocientifico2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calculocientifico2);
    }

    public void subcient(View view) {
        Intent intent = new Intent(this,Menuresultado12.class);

        EditText editTextnum1 = (EditText)findViewById(R.id.ncient);
        EditText editTextnum2 = (EditText)findViewById(R.id.ncient3);
