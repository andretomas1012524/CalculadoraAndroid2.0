...
public class Menuresultado8 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_menuresultado8);
        Intent intent = getIntent();

        double num1 = intent.getDoubleExtra(calculobasico7.Numerobasico1,0.00);
        double num2 = intent.getDoubleExtra(calculobasico7.Numerobasico2,0.00);
        ...
        TextView textViewres = (TextView)findViewById(R.id.textRes8);
        double res = Funcoesbasicas.raiz();
