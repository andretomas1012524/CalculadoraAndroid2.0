...
public class calculobasico3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calculobasico3);
    }

    public void calcularbasicodiv(View view) {
        Intent intent = new Intent(this,Menuresultado4.class);

        EditText editTextnum1 = (EditText)findViewById(R.id.nbasico17);
        EditText editTextnum2 = (EditText)findViewById(R.id.nbasico18);
