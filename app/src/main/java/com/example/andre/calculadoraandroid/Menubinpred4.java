...
public class Menubinpred4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menubinpred4);
    }

    public void calbindivpred(View view) {
        Intent intent = new Intent(this,Menuresbinpred4.class);
        EditText editTextnum1 = (EditText)findViewById(R.id.editText19);
        EditText editTextnum2 = (EditText)findViewById(R.id.editText20);
        EditText editTextnum3 = (EditText)findViewById(R.id.editText21);
        double num1;
        double num2;
        double n = 1;
        try {
