...
public class Menubinpred2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menubinpred2);
    }

    public void calbinsubpred(View view) {
        Intent intent = new Intent(this,Menuresbinpred2.class);
        EditText editTextnum1 = (EditText)findViewById(R.id.editText13);
        EditText editTextnum2 = (EditText)findViewById(R.id.editText14);
        EditText editTextnum3 = (EditText)findViewById(R.id.editText15);
        double num1;
        double num2;
        double n = 1;
