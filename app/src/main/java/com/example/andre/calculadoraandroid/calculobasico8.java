...
public class calculobasico8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calculobasico8);
    }

    public void calcularbasicoraizpred(View view) {
        Intent intent = new Intent(this,Menuresultado8.class);

        EditText editTextnum1 = (EditText)findViewById(R.id.nbasico14);
        EditText editTextnum2 = (EditText)findViewById(R.id.nbasico15);
        EditText editTextnum3 = (EditText)findViewById(R.id.ndaraiz);
        ...
        try {
            n = Double.parseDouble(editTextnum3.getText().toString());
        }catch (NumberFormatException e){
            editTextnum3.setError("Numero 2 Invalido!! Porfavor preencha.");
            editTextnum3.requestFocus();
            return;
        }
        if(n>10 || n<0){
            editTextnum3.setError("Numero 3 invalido !!! Intervalo[0,10]");
            editTextnum3.requestFocus();
            return;
        }
