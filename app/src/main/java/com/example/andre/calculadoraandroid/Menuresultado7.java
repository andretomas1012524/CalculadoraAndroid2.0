...
public class Menuresultado7 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_menuresultado7);
        Intent intent = getIntent();

        double num1 = intent.getDoubleExtra(calculobasico6.Numerobasico1,0.00);
        double num2 = intent.getDoubleExtra(calculobasico6.Numerobasico2,0.00);
        ...
        TextView textViewres = (TextView)findViewById(R.id.textRes7);
        double res = Funcoesbasicas.potencia();
