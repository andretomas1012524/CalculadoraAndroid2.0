...
public class Menubin2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menubin2);
    }

    public void calbinmult(View view) {
        Intent intent = new Intent(this,Menuresbin3.class);
        EditText editTextnum1 = (EditText)findViewById(R.id.editText3);
        EditText editTextnum2 = (EditText)findViewById(R.id.editText4);
        double num1;
        double num2;
        try {
