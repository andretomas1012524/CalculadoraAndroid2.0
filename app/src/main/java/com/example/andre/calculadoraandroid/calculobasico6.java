...
public class calculobasico6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calculobasico6);
    }

    public void calcularbasicopotn(View view) {
        Intent intent = new Intent(this,Menuresultado7.class);

        EditText editTextnum1 = (EditText)findViewById(R.id.nbasico10);
        EditText editTextnum2 = (EditText)findViewById(R.id.nbasico11);
