...
public class calculobasico1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calculobasico1);
    }

    public void calcularbasicosub(View view) {
        Intent intent = new Intent(this,Menuresultado2.class);
        EditText editTextnum1 = (EditText)findViewById(R.id.nbasico4);
        EditText editTextnum2 = (EditText)findViewById(R.id.nbasico5);
