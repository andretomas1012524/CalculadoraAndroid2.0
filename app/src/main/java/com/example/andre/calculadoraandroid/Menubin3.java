...
public class Menubin3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menubin3);
    }

    public void calbindiv(View view) {
        Intent intent = new Intent(this,Menuresbin4.class);
        EditText editTextnum1 = (EditText)findViewById(R.id.editText8);
        EditText editTextnum2 = (EditText)findViewById(R.id.editText9);
        double num1;
        double num2;
        try {
