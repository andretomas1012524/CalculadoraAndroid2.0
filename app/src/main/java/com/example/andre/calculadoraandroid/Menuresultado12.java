...
public class Menuresultado12 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_menuresultado12);
        Intent intent = getIntent();

        long num1 = (long) intent.getDoubleExtra(calculocientifico2.Numerocient1,0.00);
        long num2 = (long) intent.getDoubleExtra(calculocientifico2.Numerocient2,0.00);
